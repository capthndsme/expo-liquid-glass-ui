...
// example/tsconfig.json. The library — the glass view under `src/core` and the control kit
// around it — resolves from source, so nothing needs building to try a change.
config.resolver.extraNodeModules = {
  "expo-liquid-glass-ui": path.resolve(root, "src"),
};
